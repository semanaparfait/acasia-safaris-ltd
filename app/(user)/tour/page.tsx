    ...
    <div className="bg-[#fcfcfc] text-[#0a120b] font-serif overflow-hidden">
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 md:px-12 border-b border-[#0a120b]/5">
        <div className="flex flex-col lg:flex-row justify-between items-end gap-12">
          ...
          <div className="flex overflow-x-auto gap-8 pb-4 scrollbar-hide w-full lg:w-auto">
            <button
              onClick={() => setActiveCategory("All")}
              className={`flex items-center gap-3 font-sans text-[10px] font-bold uppercase tracking-[0.2em] whitespace-nowrap transition-colors pb-2 border-b ${
                activeCategory === "All"
